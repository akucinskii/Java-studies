...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        // factoryUseCase.getComputerPartByName("NetworkCard");

        // ComputerPart hardDiscComputerPart =
        // factoryUseCase.getComputerPartByName("HardDisc");

        // ComputerPart videoCardComputerPart =
        // factoryUseCase.getComputerPartByName("VideoCard");
